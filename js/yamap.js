...
var spinner = $(".ymap__container").children(".loader");
...
function init() {
  ...
  myMapTemp.geoObjects.add(myGeoObject);
...
// Основная функция, которая проверяет когда мы навели на блок с классом &#34;ymap__container&#34;
var ymap = function () {
  $(".ymap__container").mouseenter(function () {
    if (!check_if_load) {
